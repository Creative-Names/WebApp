...
@employer_bp.route('/', strict_slashes=False, methods=['GET', 'POST'])
def home():
    ...
    if request.args.get('delete') == 'True':
        ...
        flash(Markup(
            f"<a href=\"{HTTP_STATUS}{SERVER_NAME}/employer?delete=True&confirm=True\" class=\"alert-link\">Delete Account Permanently? </a>"))
        return render_template('employer_index.html', dmmers=dmmers)
...
@employer_bp.route('/update_details',  methods=["GET", "POST"], strict_slashes=False)
@login_required   
def update_shopkeeper_details():
    ...
    if request.args.get('delete') == 'True':
        ...
        flash(Markup(
            f"<a href=\"{HTTP_STATUS}{SERVER_NAME}/employer/update_details?delete=True&confirm=True\" class=\"alert-link\">Delete Account Permanently? </a>"))
        return render_template('employer_updateDetails.html', dmmers=dmmers)
